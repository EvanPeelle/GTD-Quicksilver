...
// var scripts = (function() {
  ...
  if (client.isAuthenticated()) {
    ...
    datastoreManager.openDefaultDatastore(function (error, datastore) {
      ...
      var secondTask = taskTable.insert({
        taskname: 'value',
        tasktype: 'action',
        completed: false,
        created: new Date()
      ...
      var taskname = secondTask.get('taskname');
      secondTask.set('completed', true);
      secondTask.deleteRecord();
      secondTask.deleteRecord();
...
//with every return - do query on that current li text,
  //return object, to alter it,
  //send back up to same id key and with updated stuff.
  //then move to next item.

/*when return is hit -
    create a new record
      with that value inside...

      how do i track that value?
      if i do a query with the value that is bring tracked on the browser?
